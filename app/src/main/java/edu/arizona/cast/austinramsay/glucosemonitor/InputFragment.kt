...
/*
 * The input fragment is the section where a user can input their glucose values for the day.
 * Once a user has input their values, they can store this information and it will be put into
 * a database for future reference. We provide input fields for each glucose value, a button to
 * switch to the history view to see previously entered values along with their details,
 * and a clear button to blank out all input fields provided.
 */
class InputFragment : Fragment(R.layout.input_view) {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        model.glucose.observe(viewLifecycleOwner, Observer<Glucose> { newGlucose ->
