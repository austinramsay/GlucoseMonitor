...
/*
 * SharedViewModel is the view model used across both the history fragment and input calculator
 * fragment. This allows both fragments to share data and provides a central place for data that
 * is needed between both fragments.
 */
